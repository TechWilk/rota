    ...
    switch ($version) {
        ...
        case "2.6.0":
            $sql = "ALTER TABLE cr_users
							...
							CREATE TABLE IF NOT EXISTS cr_swaps (
								id int(11) NOT NULL AUTO_INCREMENT,
							...
							CREATE TABLE IF NOT EXISTS cr_eventSubTypes (
							...
							CREATE TABLE IF NOT EXISTS cr_eventGroups (
								id int(30) NOT NULL AUTO_INCREMENT,
								name varchar(128) NOT NULL,
								description text NOT NULL,
							...
							CREATE TABLE IF NOT EXISTS cr_emails (
								id int(30) NOT NULL AUTO_INCREMENT,
            ...
            executeDbSql($sql);
            executeDbSql("update cr_settings set version = '3.0.0-pre1'");
        ...
        case "3.0.0-pre1":
            $sql = "CREATE TABLE IF NOT EXISTS cr_notifications (
								id int(30) NOT NULL AUTO_INCREMENT,
							...
							CREATE TABLE IF NOT EXISTS cr_notificationClicks (
								id int(30) NOT NULL AUTO_INCREMENT,
							...
							";
            executeDbSql($sql);
            executeDbSql("update cr_settings set version = '3.0.0-pre2'");
