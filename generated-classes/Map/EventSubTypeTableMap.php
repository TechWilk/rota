...
class EventSubTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.EventSubTypeTableMap';
     ...
     */
    const OM_CLASS = '\\EventSubType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EventSubType';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\EventSubType');
        $this->setPackage('');
  ...
  array(
    ...
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if (null !== ($obj = EventSubTypeTableMap::getInstanceFromPool($key))) {
            ...
            $col = $offset + EventSubTypeTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = EventSubTypeTableMap::OM_CLASS;
            /** @var EventSubType $obj */
            $obj = new $cls();
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = EventSubTypeTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = EventSubTypeTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(EventSubTypeTableMap::COL_NAME);
            $criteria->addSelectColumn(EventSubTypeTableMap::COL_DESCRIPTION);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
         ...
         if ($values instanceof Criteria) {
             // rename for clarity
            $criteria = $values;
         } elseif ($values instanceof \EventSubType) { // it's a model object
