...
class UserTableMap extends TableMap
{
    ...
    {
        $this->addRelation('CalendarToken', '\\CalendarToken', RelationMap::ONE_TO_MANY, array(
  0 =>
  array(
    0 => ':userId',
    1 => ':id',
  ...
  array(
    ...
    1 => ':id',
        ...
        $this->addRelation('Notification', '\\Notification', RelationMap::ONE_TO_MANY, array(
  0 =>
  array(
    0 => ':userId',
    1 => ':id',
        ...
        $this->addRelation('SocialAuth', '\\SocialAuth', RelationMap::ONE_TO_ONE, array(
  0 =>
  array(
    0 => ':userId',
    1 => ':id',
  ...
  array(
    ...
    1 => ':id',
        ...
        $this->addRelation('UserRole', '\\UserRole', RelationMap::ONE_TO_MANY, array(
  0 =>
  array(
    0 => ':userId',
    1 => ':id',
