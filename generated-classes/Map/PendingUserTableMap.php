...
class PendingUserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PendingUserTableMap';
     ...
     */
    const OM_CLASS = '\\PendingUser';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PendingUser';
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
         ...
         if ($values instanceof Criteria) {
             // rename for clarity
            $criteria = $values;
         } elseif ($values instanceof \PendingUser) { // it's a model object
