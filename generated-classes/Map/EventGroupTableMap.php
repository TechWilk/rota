...
class EventGroupTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.EventGroupTableMap';
     ...
     */
    const OM_CLASS = '\\EventGroup';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'EventGroup';
    ...
    protected static $fieldNames = array(
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Description', 'Archived', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'description', 'archived', ),
        self::TYPE_COLNAME       => array(EventGroupTableMap::COL_ID, EventGroupTableMap::COL_NAME, EventGroupTableMap::COL_DESCRIPTION, EventGroupTableMap::COL_ARCHIVED, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'description', 'archived', ),
    ...
    protected static $fieldKeys = array(
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Description' => 2, 'Archived' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'archived' => 3, ),
        self::TYPE_COLNAME       => array(EventGroupTableMap::COL_ID => 0, EventGroupTableMap::COL_NAME => 1, EventGroupTableMap::COL_DESCRIPTION => 2, EventGroupTableMap::COL_ARCHIVED => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'archived' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
  ...
  array(
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(EventGroupTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(EventGroupTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new EventGroupTableMap());
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
         ...
         if ($values instanceof Criteria) {
             // rename for clarity
            $criteria = $values;
         } elseif ($values instanceof \EventGroup) { // it's a model object
...
//
EventGroupTableMap::buildTableMap();
