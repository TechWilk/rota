...
use \NotificationClick;
use \NotificationClickQuery;
...
class NotificationClickTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.NotificationClickTableMap';
     ...
     */
    const OM_CLASS = '\\NotificationClick';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'NotificationClick';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\NotificationClick');
        $this->setPackage('');
    ...
    {
        $this->addRelation('Notification', '\\Notification', RelationMap::MANY_TO_ONE, array(
  0 =>
  array(
    0 => ':notificationId',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
         ...
         if ($values instanceof Criteria) {
             // rename for clarity
            $criteria = $values;
         } elseif ($values instanceof \NotificationClick) { // it's a model object
