...
class UserRoleTableMap extends TableMap
{
  ...
  array(
    ...
    1 => ':id',
        ...
        $this->addRelation('EventPerson', '\\EventPerson', RelationMap::ONE_TO_MANY, array(
  0 =>
  array(
    0 => ':userRoleId',
    1 => ':id',
        ...
        $this->addRelation('SwapRelatedByOldUserRoleId', '\\Swap', RelationMap::ONE_TO_MANY, array(
  0 =>
  array(
    0 => ':oldUserRoleId',
    1 => ':id',
        ...
        $this->addRelation('SwapRelatedByNewUserRoleId', '\\Swap', RelationMap::ONE_TO_MANY, array(
  0 =>
  array(
    0 => ':newUserRoleId',
    1 => ':id',
