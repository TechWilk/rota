...
class PermissionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TechWilk.Rota.Map.PermissionTableMap';
     ...
     */
    const OM_CLASS = '\\TechWilk\\Rota\\Permission';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TechWilk.Rota.Permission';
    ...
    protected static $fieldNames = array(
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Description', 'Slug', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'description', 'slug', ),
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_ID, PermissionTableMap::COL_NAME, PermissionTableMap::COL_DESCRIPTION, PermissionTableMap::COL_SLUG, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'description', 'slug', ),
    ...
    protected static $fieldKeys = array(
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Description' => 2, 'Slug' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'slug' => 3, ),
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_ID => 0, PermissionTableMap::COL_NAME => 1, PermissionTableMap::COL_DESCRIPTION => 2, PermissionTableMap::COL_SLUG => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'description' => 2, 'slug' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
