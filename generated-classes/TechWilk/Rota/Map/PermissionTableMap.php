...
class PermissionTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'TechWilk.Rota.Map.PermissionTableMap';
     ...
     */
    public const OM_CLASS = '\\TechWilk\\Rota\\Permission';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'TechWilk.Rota.Permission';
     ...
     */
    public const COL_NAME = 'permissions.name';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Name', 'Description', 'Slug', ],
        self::TYPE_CAMELNAME     => ['id', 'name', 'description', 'slug', ],
        self::TYPE_COLNAME       => [PermissionTableMap::COL_ID, PermissionTableMap::COL_NAME, PermissionTableMap::COL_DESCRIPTION, PermissionTableMap::COL_SLUG, ],
        self::TYPE_FIELDNAME     => ['id', 'name', 'description', 'slug', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Name' => 1, 'Description' => 2, 'Slug' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'name' => 1, 'description' => 2, 'slug' => 3, ],
        self::TYPE_COLNAME       => [PermissionTableMap::COL_ID => 0, PermissionTableMap::COL_NAME => 1, PermissionTableMap::COL_DESCRIPTION => 2, PermissionTableMap::COL_SLUG => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'name' => 1, 'description' => 2, 'slug' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'name' => 'NAME',
        'permission.name' => 'NAME',
        'PermissionTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
    ...
    public function initialize(): void
    {
        ...
        $this->addColumn('slug', 'Slug', 'VARCHAR', true, 10, null);
    }
  ...
  array (
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(PermissionTableMap::COL_NAME);
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TechWilk\Rota\Permission) { // it's a model object
