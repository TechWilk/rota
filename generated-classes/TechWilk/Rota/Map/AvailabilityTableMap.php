...
class AvailabilityTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'TechWilk.Rota.Map.AvailabilityTableMap';
     ...
     */
    public const TABLE_NAME = 'availability';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'Availability';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\TechWilk\\Rota\\Availability';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'TechWilk.Rota.Availability';
     ...
     */
    public const COL_ID = 'availability.id';

    /**
     * the column name for the eventId field
     */
    public const COL_EVENTID = 'availability.eventId';

    /**
     * the column name for the userId field
     */
    public const COL_USERID = 'availability.userId';

    /**
     * the column name for the available field
     */
    public const COL_AVAILABLE = 'availability.available';

    /**
     * the column name for the comment field
     */
    public const COL_COMMENT = 'availability.comment';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'EventId', 'UserId', 'Available', 'Comment', ],
        self::TYPE_CAMELNAME     => ['id', 'eventId', 'userId', 'available', 'comment', ],
        self::TYPE_COLNAME       => [AvailabilityTableMap::COL_ID, AvailabilityTableMap::COL_EVENTID, AvailabilityTableMap::COL_USERID, AvailabilityTableMap::COL_AVAILABLE, AvailabilityTableMap::COL_COMMENT, ],
        self::TYPE_FIELDNAME     => ['id', 'eventId', 'userId', 'available', 'comment', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'EventId' => 1, 'UserId' => 2, 'Available' => 3, 'Comment' => 4, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'eventId' => 1, 'userId' => 2, 'available' => 3, 'comment' => 4, ],
        self::TYPE_COLNAME       => [AvailabilityTableMap::COL_ID => 0, AvailabilityTableMap::COL_EVENTID => 1, AvailabilityTableMap::COL_USERID => 2, AvailabilityTableMap::COL_AVAILABLE => 3, AvailabilityTableMap::COL_COMMENT => 4, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'eventId' => 1, 'userId' => 2, 'available' => 3, 'comment' => 4, ],
        self::TYPE_NUM           => [0, 1, 2, 3, 4, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'id' => 'ID',
        'availability.id' => 'ID',
        'AvailabilityTableMap::COL_ID' => 'ID',
        'COL_ID' => 'ID',
        'EventId' => 'EVENTID',
        'Availability.EventId' => 'EVENTID',
        'eventId' => 'EVENTID',
        'availability.eventId' => 'EVENTID',
        'AvailabilityTableMap::COL_EVENTID' => 'EVENTID',
        'COL_EVENTID' => 'EVENTID',
        'UserId' => 'USERID',
        'Availability.UserId' => 'USERID',
        'userId' => 'USERID',
        'availability.userId' => 'USERID',
        'AvailabilityTableMap::COL_USERID' => 'USERID',
        'COL_USERID' => 'USERID',
        'Available' => 'AVAILABLE',
        'Availability.Available' => 'AVAILABLE',
        'available' => 'AVAILABLE',
        'availability.available' => 'AVAILABLE',
        'AvailabilityTableMap::COL_AVAILABLE' => 'AVAILABLE',
        'COL_AVAILABLE' => 'AVAILABLE',
        'Comment' => 'COMMENT',
        'Availability.Comment' => 'COMMENT',
        'comment' => 'COMMENT',
        'availability.comment' => 'COMMENT',
        'AvailabilityTableMap::COL_COMMENT' => 'COMMENT',
        'COL_COMMENT' => 'COMMENT',
    ];
  ...
  array (
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(AvailabilityTableMap::COL_ID);
            $criteria->removeSelectColumn(AvailabilityTableMap::COL_EVENTID);
            $criteria->removeSelectColumn(AvailabilityTableMap::COL_USERID);
            $criteria->removeSelectColumn(AvailabilityTableMap::COL_AVAILABLE);
            $criteria->removeSelectColumn(AvailabilityTableMap::COL_COMMENT);
        } else {
