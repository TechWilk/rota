...
class LoginFailureTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'TechWilk.Rota.Map.LoginFailureTableMap';
     ...
     */
    public const TABLE_NAME = 'loginFailures';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'LoginFailure';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\TechWilk\\Rota\\LoginFailure';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'TechWilk.Rota.LoginFailure';
     ...
     */
    public const COL_USERNAME = 'loginFailures.username';

    /**
     * the column name for the ipAddress field
     */
    public const COL_IPADDRESS = 'loginFailures.ipAddress';

    /**
     * the column name for the timestamp field
     */
    public const COL_TIMESTAMP = 'loginFailures.timestamp';
    ...
    protected static $fieldNames = [
        ...
        self::TYPE_COLNAME       => [LoginFailureTableMap::COL_USERNAME, LoginFailureTableMap::COL_IPADDRESS, LoginFailureTableMap::COL_TIMESTAMP, ],
    ...
    protected static $fieldKeys = [
        ...
        self::TYPE_COLNAME       => [LoginFailureTableMap::COL_USERNAME => 0, LoginFailureTableMap::COL_IPADDRESS => 1, LoginFailureTableMap::COL_TIMESTAMP => 2, ],
    ...
    protected $normalizedColumnNameMap = [
        'Username' => 'USERNAME',
        'LoginFailure.Username' => 'USERNAME',
        'username' => 'USERNAME',
        'loginFailure.username' => 'USERNAME',
        'LoginFailureTableMap::COL_USERNAME' => 'USERNAME',
        'COL_USERNAME' => 'USERNAME',
        'loginFailures.username' => 'USERNAME',
        'ipAddress' => 'IPADDRESS',
        'LoginFailure.ipAddress' => 'IPADDRESS',
        'loginFailure.ipAddress' => 'IPADDRESS',
        'LoginFailureTableMap::COL_IPADDRESS' => 'IPADDRESS',
        'COL_IPADDRESS' => 'IPADDRESS',
        'loginFailures.ipAddress' => 'IPADDRESS',
        'Timestamp' => 'TIMESTAMP',
        'LoginFailure.Timestamp' => 'TIMESTAMP',
        'timestamp' => 'TIMESTAMP',
        'loginFailure.timestamp' => 'TIMESTAMP',
        'LoginFailureTableMap::COL_TIMESTAMP' => 'TIMESTAMP',
        'COL_TIMESTAMP' => 'TIMESTAMP',
        'loginFailures.timestamp' => 'TIMESTAMP',
    ];
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(LoginFailureTableMap::COL_USERNAME);
            $criteria->removeSelectColumn(LoginFailureTableMap::COL_IPADDRESS);
            $criteria->removeSelectColumn(LoginFailureTableMap::COL_TIMESTAMP);
        } else {
            $criteria->removeSelectColumn($alias . '.username');
            $criteria->removeSelectColumn($alias . '.ipAddress');
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TechWilk\Rota\LoginFailure) { // it's a model object
