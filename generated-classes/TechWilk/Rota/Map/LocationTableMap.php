...
class LocationTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'TechWilk.Rota.Map.LocationTableMap';
     ...
     */
    public const OM_CLASS = '\\TechWilk\\Rota\\Location';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'TechWilk.Rota.Location';
     ...
     */
    public const COL_ID = 'locations.id';

    /**
     * the column name for the name field
     */
    public const COL_NAME = 'locations.name';

    /**
     * the column name for the address field
     */
    public const COL_ADDRESS = 'locations.address';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'Name', 'Address', ],
        self::TYPE_CAMELNAME     => ['id', 'name', 'address', ],
        self::TYPE_COLNAME       => [LocationTableMap::COL_ID, LocationTableMap::COL_NAME, LocationTableMap::COL_ADDRESS, ],
        self::TYPE_FIELDNAME     => ['id', 'name', 'address', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'Name' => 1, 'Address' => 2, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'name' => 1, 'address' => 2, ],
        self::TYPE_COLNAME       => [LocationTableMap::COL_ID => 0, LocationTableMap::COL_NAME => 1, LocationTableMap::COL_ADDRESS => 2, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'name' => 1, 'address' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'name' => 'NAME',
        'location.name' => 'NAME',
        'LocationTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'locations.name' => 'NAME',
        'Address' => 'ADDRESS',
        ...
        'address' => 'ADDRESS',
        'location.address' => 'ADDRESS',
        'LocationTableMap::COL_ADDRESS' => 'ADDRESS',
        'COL_ADDRESS' => 'ADDRESS',
    ...
    {
        $this->addRelation('EventType', '\\TechWilk\\Rota\\EventType', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':defaultLocationId',
    1 => ':id',
  ),
), 'SET NULL', null, 'EventTypes', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LocationTableMap::COL_ADDRESS);
        } else {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(LocationTableMap::COL_ID);
            $criteria->removeSelectColumn(LocationTableMap::COL_NAME);
            $criteria->removeSelectColumn(LocationTableMap::COL_ADDRESS);
        } else {
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TechWilk\Rota\Location) { // it's a model object
