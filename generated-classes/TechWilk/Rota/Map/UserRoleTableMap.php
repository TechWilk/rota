...
class UserRoleTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = 'TechWilk.Rota.Map.UserRoleTableMap';
     ...
     */
    public const TABLE_NAME = 'userRoles';
     ...
     */
    public const OM_CLASS = '\\TechWilk\\Rota\\UserRole';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'TechWilk.Rota.UserRole';
     ...
     */
    public const COL_ID = 'userRoles.id';

    /**
     * the column name for the userId field
     */
    public const COL_USERID = 'userRoles.userId';

    /**
     * the column name for the roleId field
     */
    public const COL_ROLEID = 'userRoles.roleId';

    /**
     * the column name for the reserve field
     */
    public const COL_RESERVE = 'userRoles.reserve';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Id', 'UserId', 'RoleId', 'Reserve', ],
        self::TYPE_CAMELNAME     => ['id', 'userId', 'roleId', 'reserve', ],
        self::TYPE_COLNAME       => [UserRoleTableMap::COL_ID, UserRoleTableMap::COL_USERID, UserRoleTableMap::COL_ROLEID, UserRoleTableMap::COL_RESERVE, ],
        self::TYPE_FIELDNAME     => ['id', 'userId', 'roleId', 'reserve', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Id' => 0, 'UserId' => 1, 'RoleId' => 2, 'Reserve' => 3, ],
        self::TYPE_CAMELNAME     => ['id' => 0, 'userId' => 1, 'roleId' => 2, 'reserve' => 3, ],
        self::TYPE_COLNAME       => [UserRoleTableMap::COL_ID => 0, UserRoleTableMap::COL_USERID => 1, UserRoleTableMap::COL_ROLEID => 2, UserRoleTableMap::COL_RESERVE => 3, ],
        self::TYPE_FIELDNAME     => ['id' => 0, 'userId' => 1, 'roleId' => 2, 'reserve' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'userId' => 'USERID',
        'userRole.userId' => 'USERID',
        'UserRoleTableMap::COL_USERID' => 'USERID',
        'COL_USERID' => 'USERID',
        ...
        'roleId' => 'ROLEID',
        'userRole.roleId' => 'ROLEID',
        'UserRoleTableMap::COL_ROLEID' => 'ROLEID',
        'COL_ROLEID' => 'ROLEID',
        'userRoles.roleId' => 'ROLEID',
        'Reserve' => 'RESERVE',
        'UserRole.Reserve' => 'RESERVE',
        'reserve' => 'RESERVE',
        'userRole.reserve' => 'RESERVE',
        'UserRoleTableMap::COL_RESERVE' => 'RESERVE',
        'COL_RESERVE' => 'RESERVE',
        'userRoles.reserve' => 'RESERVE',
    ];
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Role', '\\TechWilk\\Rota\\Role', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':roleId',
    1 => ':id',
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('SwapRelatedByOldUserRoleId', '\\TechWilk\\Rota\\Swap', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':oldUserRoleId',
    1 => ':id',
  ),
), null, null, 'SwapsRelatedByOldUserRoleId', false);
        $this->addRelation('SwapRelatedByNewUserRoleId', '\\TechWilk\\Rota\\Swap', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':newUserRoleId',
    1 => ':id',
  ),
), null, null, 'SwapsRelatedByNewUserRoleId', false);
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserRoleTableMap::COL_USERID);
            $criteria->addSelectColumn(UserRoleTableMap::COL_ROLEID);
            $criteria->addSelectColumn(UserRoleTableMap::COL_RESERVE);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(UserRoleTableMap::COL_USERID);
            $criteria->removeSelectColumn(UserRoleTableMap::COL_ROLEID);
            $criteria->removeSelectColumn(UserRoleTableMap::COL_RESERVE);
        } else {
            $criteria->removeSelectColumn($alias . '.id');
            $criteria->removeSelectColumn($alias . '.userId');
            $criteria->removeSelectColumn($alias . '.roleId');
            $criteria->removeSelectColumn($alias . '.reserve');
        }
    }
     ...
     */
     public static function doDelete($values, ?ConnectionInterface $con = null): int
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \TechWilk\Rota\UserRole) { // it's a model object
