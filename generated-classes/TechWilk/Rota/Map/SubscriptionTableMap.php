...
use TechWilk\Rota\Subscription;
...
class SubscriptionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'TechWilk.Rota.Map.SubscriptionTableMap';
     ...
     */
    const OM_CLASS = '\\TechWilk\\Rota\\Subscription';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'TechWilk.Rota.Subscription';
    ...
    protected static $fieldNames = array(
        self::TYPE_PHPNAME       => array('Id', 'Userid', 'Categoryid', 'Topicid', ),
        self::TYPE_CAMELNAME     => array('id', 'userid', 'categoryid', 'topicid', ),
        self::TYPE_COLNAME       => array(SubscriptionTableMap::COL_ID, SubscriptionTableMap::COL_USERID, SubscriptionTableMap::COL_CATEGORYID, SubscriptionTableMap::COL_TOPICID, ),
        self::TYPE_FIELDNAME     => array('id', 'userid', 'categoryid', 'topicid', ),
    ...
    protected static $fieldKeys = array(
        self::TYPE_PHPNAME       => array('Id' => 0, 'Userid' => 1, 'Categoryid' => 2, 'Topicid' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'userid' => 1, 'categoryid' => 2, 'topicid' => 3, ),
        self::TYPE_COLNAME       => array(SubscriptionTableMap::COL_ID => 0, SubscriptionTableMap::COL_USERID => 1, SubscriptionTableMap::COL_CATEGORYID => 2, SubscriptionTableMap::COL_TOPICID => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'userid' => 1, 'categoryid' => 2, 'topicid' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('categoryid', 'Categoryid', 'INTEGER', true, 4, 0);
        $this->addColumn('topicid', 'Topicid', 'INTEGER', true, 4, 0);
    } // initialize()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SubscriptionTableMap::COL_USERID);
            $criteria->addSelectColumn(SubscriptionTableMap::COL_CATEGORYID);
            $criteria->addSelectColumn(SubscriptionTableMap::COL_TOPICID);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.userid');
            $criteria->addSelectColumn($alias . '.categoryid');
            $criteria->addSelectColumn($alias . '.topicid');
        }
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
         ...
         if ($values instanceof Criteria) {
             // rename for clarity
            $criteria = $values;
         } elseif ($values instanceof \TechWilk\Rota\Subscription) { // it's a model object
