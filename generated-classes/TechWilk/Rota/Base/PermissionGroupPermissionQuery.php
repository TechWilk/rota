 ...
 *
 * @method     ChildPermissionGroupPermission|null findOne(?ConnectionInterface $con = null) Return the first ChildPermissionGroupPermission matching the query
 ...
 *
 * @method     ChildPermissionGroupPermission|null findOneById(int $id) Return the first ChildPermissionGroupPermission filtered by the id column
 * @method     ChildPermissionGroupPermission|null findOneByUserId(int $permissionId) Return the first ChildPermissionGroupPermission filtered by the permissionId column
 * @method     ChildPermissionGroupPermission|null findOneByPermissionId(int $permissionGroupId) Return the first ChildPermissionGroupPermission filtered by the permissionGroupId column
 *
 ...
 *
 * @method     ChildPermissionGroupPermission[]|Collection find(?ConnectionInterface $con = null) Return ChildPermissionGroupPermission objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildPermissionGroupPermission> find(?ConnectionInterface $con = null) Return ChildPermissionGroupPermission objects based on current ModelCriteria
 *
 * @method     ChildPermissionGroupPermission[]|Collection findById(int|array<int> $id) Return ChildPermissionGroupPermission objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildPermissionGroupPermission> findById(int|array<int> $id) Return ChildPermissionGroupPermission objects filtered by the id column
 * @method     ChildPermissionGroupPermission[]|Collection findByUserId(int|array<int> $permissionId) Return ChildPermissionGroupPermission objects filtered by the permissionId column
 * @psalm-method Collection&\Traversable<ChildPermissionGroupPermission> findByUserId(int|array<int> $permissionId) Return ChildPermissionGroupPermission objects filtered by the permissionId column
 * @method     ChildPermissionGroupPermission[]|Collection findByPermissionId(int|array<int> $permissionGroupId) Return ChildPermissionGroupPermission objects filtered by the permissionGroupId column
 * @psalm-method Collection&\Traversable<ChildPermissionGroupPermission> findByPermissionId(int|array<int> $permissionGroupId) Return ChildPermissionGroupPermission objects filtered by the permissionGroupId column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildPermissionGroupPermission> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class PermissionGroupPermissionQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(PermissionGroupPermissionTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(PermissionGroupPermissionTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(PermissionGroupPermissionTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByUserId($userId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(PermissionGroupPermissionTableMap::COL_PERMISSIONID, $userId, $comparison);
    ...
    public function filterByPermissionId($permissionId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(PermissionGroupPermissionTableMap::COL_PERMISSIONGROUPID, $permissionId, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByPermissionGroup($permissionGroup, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinPermissionGroup(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * Use the PermissionGroup relation PermissionGroup object
     *
     * @param callable(\TechWilk\Rota\PermissionGroupQuery):\TechWilk\Rota\PermissionGroupQuery $callable A function working on the related query
     *
     * @param string|null $relationAlias optional alias for the relation
     *
     * @param string|null $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     ...
     * @return $this
     */
    public function withPermissionGroupQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->usePermissionGroupQuery(
            $relationAlias,
            $joinType
        );
        $callable($relatedQuery);
    ...
    /**
     * Use the relation to PermissionGroup table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @param string $typeOfExists Either ExistsQueryCriterion::TYPE_EXISTS or ExistsQueryCriterion::TYPE_NOT_EXISTS
     *
     * @return \TechWilk\Rota\PermissionGroupQuery The inner query object of the EXISTS statement
     */
    public function usePermissionGroupExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \TechWilk\Rota\PermissionGroupQuery */
        $q = $this->useExistsQuery('PermissionGroup', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the relation to PermissionGroup table for a NOT EXISTS query.
     *
     * @see usePermissionGroupExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \TechWilk\Rota\PermissionGroupQuery The inner query object of the NOT EXISTS statement
     */
    public function usePermissionGroupNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \TechWilk\Rota\PermissionGroupQuery */
        $q = $this->useExistsQuery('PermissionGroup', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the relation to PermissionGroup table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @param string $typeOfIn Criteria::IN or Criteria::NOT_IN
     *
     * @return \TechWilk\Rota\PermissionGroupQuery The inner query object of the IN statement
     */
    public function useInPermissionGroupQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \TechWilk\Rota\PermissionGroupQuery */
        $q = $this->useInQuery('PermissionGroup', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the relation to PermissionGroup table for a NOT IN query.
     *
     * @see usePermissionGroupInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \TechWilk\Rota\PermissionGroupQuery The inner query object of the NOT IN statement
     */
    public function useNotInPermissionGroupQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \TechWilk\Rota\PermissionGroupQuery */
        $q = $this->useInQuery('PermissionGroup', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
