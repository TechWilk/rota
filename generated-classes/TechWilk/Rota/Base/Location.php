...
abstract class Location implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\TechWilk\\Rota\\Map\\LocationTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildEventType> Collection to store aggregation of ChildEventType objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildEventType>
     */
    ...
    /**
     * Initializes internal state of TechWilk\Rota\Base\Location object.
     */
    ...
    public function setAddress($v)
    {
        ...
        if ($this->address !== $v) {
            $this->address = $v;
            $this->modifiedColumns[LocationTableMap::COL_ADDRESS] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LocationTableMap::translateFieldName('Address', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\TechWilk\\Rota\\Location'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(LocationTableMap::COL_ADDRESS)) {
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(LocationTableMap::COL_ADDRESS)) {
            $criteria->add(LocationTableMap::COL_ADDRESS, $this->address);
        }
     ...
     * objects.
     *
     * @param object $copyObj An object of \TechWilk\Rota\Location (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TechWilk\Rota\Location Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @return void
     */
    public function resetPartialEventTypes($v = true): void
    {
    ...
    public function initEventTypes(bool $overrideExisting = true): void
    {
        ...
        $this->collEventTypes->setModel('\TechWilk\Rota\EventType');
    }
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildEventType> List of ChildEventType objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collEventTypes || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collEventTypes) {
                    ...
                    $collEventTypes->setModel('\TechWilk\Rota\EventType');
    ...
    public function setEventTypes(Collection $eventTypes, ?ConnectionInterface $con = null)
    {
        ...
        foreach ($eventTypesToDelete as $eventTypeRemoved) {
            $eventTypeRemoved->setLocation(null);
        }
     ...
     */
    protected function doAddEventType(ChildEventType $eventType): void
    {
        $this->collEventTypes[]= $eventType;
        $eventType->setLocation($this);
    }
