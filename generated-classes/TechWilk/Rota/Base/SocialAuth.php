...
abstract class SocialAuth implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TechWilk\\Rota\\Map\\SocialAuthTableMap';
    ...
    /**
     * Initializes internal state of TechWilk\Rota\Base\SocialAuth object.
     * @see applyDefaults()
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TechWilk\Rota\SocialAuth
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TechWilk\Rota\SocialAuth The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TechWilk\Rota\SocialAuth (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TechWilk\Rota\SocialAuth Clone of current object.
     * @throws PropelException
     */
