...
/**
 * Base class that represents a row from the 'eventTypes' table.
 *
 *
 *
...
abstract class EventType implements ActiveRecordInterface
{
    ...
    /**
     * Initializes internal state of TechWilk\Rota\Base\EventType object.
     * @see applyDefaults()
     */
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO eventTypes (%s) VALUES (%s)',
