...
abstract class UserPermission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TechWilk\\Rota\\Map\\UserPermissionTableMap';
    ...
    /**
     * Initializes internal state of TechWilk\Rota\Base\UserPermission object.
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|UserPermission The current object, for fluid interface
     */
     ...
     * @return $this|\TechWilk\Rota\UserPermission The current object (for fluent API support)
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[UserPermissionTableMap::COL_USERID] = true;
        }
    ...
    public function setPermissionId($v)
    {
        ...
        if ($this->permissionid !== $v) {
            $this->permissionid = $v;
            $this->modifiedColumns[UserPermissionTableMap::COL_PERMISSIONID] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserPermissionTableMap::COL_CREATED] = true;
            }
    ...
    public function setUpdated($v)
    {
        ...
        if ($this->updated !== null || $dt !== null) {
            if ($this->updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserPermissionTableMap::COL_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UserPermissionTableMap::translateFieldName('PermissionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->permissionid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserPermissionTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserPermissionTableMap::translateFieldName('Updated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = UserPermissionTableMap::NUM_HYDRATE_COLUMNS.
        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\TechWilk\\Rota\\UserPermission'), 0, $e);
        }
    }
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(UserPermissionTableMap::COL_CREATED)) {
                    $this->setCreated(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
                if (!$this->isColumnModified(UserPermissionTableMap::COL_UPDATED)) {
                    $this->setUpdated(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(UserPermissionTableMap::COL_UPDATED)) {
                    $this->setUpdated(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserPermissionTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userId';
        }
        if ($this->isColumnModified(UserPermissionTableMap::COL_PERMISSIONID)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TechWilk\Rota\UserPermission
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TechWilk\Rota\UserPermission The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserPermissionTableMap::COL_USERID)) {
            $criteria->add(UserPermissionTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(UserPermissionTableMap::COL_PERMISSIONID)) {
            $criteria->add(UserPermissionTableMap::COL_PERMISSIONID, $this->permissionid);
        }
        if ($this->isColumnModified(UserPermissionTableMap::COL_CREATED)) {
            $criteria->add(UserPermissionTableMap::COL_CREATED, $this->created);
        }
        if ($this->isColumnModified(UserPermissionTableMap::COL_UPDATED)) {
            $criteria->add(UserPermissionTableMap::COL_UPDATED, $this->updated);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TechWilk\Rota\UserPermission (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TechWilk\Rota\UserPermission Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return     $this|ChildUserPermission The current object (for fluent API support)
     */
