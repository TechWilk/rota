...
use TechWilk\Rota\DocumentQuery as ChildDocumentQuery;
...
abstract class Document implements ActiveRecordInterface
{
    ...
    /**
     * Initializes internal state of TechWilk\Rota\Base\Document object.
     * @see applyDefaults()
     */
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[DocumentTableMap::COL_TITLE] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[DocumentTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setUrl($v)
    {
        ...
        if ($this->url !== $v) {
            $this->url = $v;
            $this->modifiedColumns[DocumentTableMap::COL_URL] = true;
        }
    ...
    public function setLink($v)
    {
        ...
        if ($this->link !== $v) {
            $this->link = $v;
            $this->modifiedColumns[DocumentTableMap::COL_LINK] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DocumentTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DocumentTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DocumentTableMap::translateFieldName('Url', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(DocumentTableMap::COL_TITLE)) {
            $modifiedColumns[':p' . $index++]  = 'title';
        }
        if ($this->isColumnModified(DocumentTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(DocumentTableMap::COL_URL)) {
            $modifiedColumns[':p' . $index++]  = 'url';
        }
        if ($this->isColumnModified(DocumentTableMap::COL_LINK)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DocumentTableMap::COL_TITLE)) {
            $criteria->add(DocumentTableMap::COL_TITLE, $this->title);
        }
        if ($this->isColumnModified(DocumentTableMap::COL_DESCRIPTION)) {
            $criteria->add(DocumentTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(DocumentTableMap::COL_URL)) {
            $criteria->add(DocumentTableMap::COL_URL, $this->url);
        }
        if ($this->isColumnModified(DocumentTableMap::COL_LINK)) {
            $criteria->add(DocumentTableMap::COL_LINK, $this->link);
        }
