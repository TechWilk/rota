...
/**
 * Base class that represents a row from the 'permissionGroupPermissions' table.
 *
 *
 *
...
abstract class PermissionGroupPermission implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\TechWilk\\Rota\\Map\\PermissionGroupPermissionTableMap';
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO permissionGroupPermissions (%s) VALUES (%s)',
