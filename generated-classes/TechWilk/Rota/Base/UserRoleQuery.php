 ...
 *
 * @method     \TechWilk\Rota\UserQuery|\TechWilk\Rota\RoleQuery|\TechWilk\Rota\EventPersonQuery|\TechWilk\Rota\SwapQuery|\TechWilk\Rota\SwapQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUserRole|null findOneByUserId(int $userId) Return the first ChildUserRole filtered by the userId column
 * @method     ChildUserRole|null findOneByRoleId(int $roleId) Return the first ChildUserRole filtered by the roleId column
 * @method     ChildUserRole|null findOneByReserve(boolean $reserve) Return the first ChildUserRole filtered by the reserve column
 *
 ...
 * @method     ChildUserRole[]|Collection findByUserId(int|array<int> $userId) Return ChildUserRole objects filtered by the userId column
 * @psalm-method Collection&\Traversable<ChildUserRole> findByUserId(int|array<int> $userId) Return ChildUserRole objects filtered by the userId column
 * @method     ChildUserRole[]|Collection findByRoleId(int|array<int> $roleId) Return ChildUserRole objects filtered by the roleId column
 * @psalm-method Collection&\Traversable<ChildUserRole> findByRoleId(int|array<int> $roleId) Return ChildUserRole objects filtered by the roleId column
 * @method     ChildUserRole[]|Collection findByReserve(boolean|array<boolean> $reserve) Return ChildUserRole objects filtered by the reserve column
 * @psalm-method Collection&\Traversable<ChildUserRole> findByReserve(boolean|array<boolean> $reserve) Return ChildUserRole objects filtered by the reserve column
 *
...
abstract class UserRoleQuery extends ModelCriteria
{
    ...
    public function filterByUserId($userId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(UserRoleTableMap::COL_USERID, $userId, $comparison);
    ...
    public function filterByRoleId($roleId = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(UserRoleTableMap::COL_ROLEID, $roleId, $comparison);
     ...
     * </code>
     *
     * @param bool|string $reserve The value to use as filter.
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterByReserve($reserve = null, ?string $comparison = null)
    {
        if (is_string($reserve)) {
            $reserve = in_array(strtolower($reserve), array('false', 'off', '-', 'no', 'n', '0', ''), true) ? false : true;
        }

        $this->addUsingAlias(UserRoleTableMap::COL_RESERVE, $reserve, $comparison);
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySwapRelatedByOldUserRoleId($swap, ?string $comparison = null)
    {
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSwapRelatedByOldUserRoleId(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * @return $this
     */
    public function withSwapRelatedByOldUserRoleIdQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->useSwapRelatedByOldUserRoleIdQuery(
            $relationAlias,
            $joinType
        );
        $callable($relatedQuery);
    ...
    /**
     * Use the SwapRelatedByOldUserRoleId relation to the Swap table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useSwapRelatedByOldUserRoleIdExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \TechWilk\Rota\SwapQuery */
        $q = $this->useExistsQuery('SwapRelatedByOldUserRoleId', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the SwapRelatedByOldUserRoleId relation to the Swap table for a NOT EXISTS query.
     *
     * @see useSwapRelatedByOldUserRoleIdExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useSwapRelatedByOldUserRoleIdNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \TechWilk\Rota\SwapQuery */
        $q = $this->useExistsQuery('SwapRelatedByOldUserRoleId', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the SwapRelatedByOldUserRoleId relation to the Swap table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     */
    public function useInSwapRelatedByOldUserRoleIdQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \TechWilk\Rota\SwapQuery */
        $q = $this->useInQuery('SwapRelatedByOldUserRoleId', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the SwapRelatedByOldUserRoleId relation to the Swap table for a NOT IN query.
     *
     * @see useSwapRelatedByOldUserRoleIdInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     ...
     */
    public function useNotInSwapRelatedByOldUserRoleIdQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \TechWilk\Rota\SwapQuery */
        $q = $this->useInQuery('SwapRelatedByOldUserRoleId', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
     ...
     * @return $this The current query, for fluid interface
     */
    public function filterBySwapRelatedByNewUserRoleId($swap, ?string $comparison = null)
    {
        if ($swap instanceof \TechWilk\Rota\Swap) {
            $this
     ...
     * @return $this The current query, for fluid interface
     */
    public function joinSwapRelatedByNewUserRoleId(?string $relationAlias = null, ?string $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
     ...
     * @return $this
     */
    public function withSwapRelatedByNewUserRoleIdQuery(
        callable $callable,
        string $relationAlias = null,
        ?string $joinType = Criteria::INNER_JOIN
    ) {
        $relatedQuery = $this->useSwapRelatedByNewUserRoleIdQuery(
            $relationAlias,
            $joinType
        );
        $callable($relatedQuery);
    ...
    /**
     * Use the SwapRelatedByNewUserRoleId relation to the Swap table for an EXISTS query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \TechWilk\Rota\SwapQuery The inner query object of the EXISTS statement
     */
    public function useSwapRelatedByNewUserRoleIdExistsQuery($modelAlias = null, $queryClass = null, $typeOfExists = 'EXISTS')
    {
        /** @var $q \TechWilk\Rota\SwapQuery */
        $q = $this->useExistsQuery('SwapRelatedByNewUserRoleId', $modelAlias, $queryClass, $typeOfExists);
        return $q;
    }

    /**
     * Use the SwapRelatedByNewUserRoleId relation to the Swap table for a NOT EXISTS query.
     *
     * @see useSwapRelatedByNewUserRoleIdExistsQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the exists query, like ExtendedBookQuery::class
     *
     * @return \TechWilk\Rota\SwapQuery The inner query object of the NOT EXISTS statement
     */
    public function useSwapRelatedByNewUserRoleIdNotExistsQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \TechWilk\Rota\SwapQuery */
        $q = $this->useExistsQuery('SwapRelatedByNewUserRoleId', $modelAlias, $queryClass, 'NOT EXISTS');
        return $q;
    }

    /**
     * Use the SwapRelatedByNewUserRoleId relation to the Swap table for an IN query.
     *
     * @see \Propel\Runtime\ActiveQuery\ModelCriteria::useInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     ...
     * @return \TechWilk\Rota\SwapQuery The inner query object of the IN statement
     */
    public function useInSwapRelatedByNewUserRoleIdQuery($modelAlias = null, $queryClass = null, $typeOfIn = 'IN')
    {
        /** @var $q \TechWilk\Rota\SwapQuery */
        $q = $this->useInQuery('SwapRelatedByNewUserRoleId', $modelAlias, $queryClass, $typeOfIn);
        return $q;
    }

    /**
     * Use the SwapRelatedByNewUserRoleId relation to the Swap table for a NOT IN query.
     *
     * @see useSwapRelatedByNewUserRoleIdInQuery()
     *
     * @param string|null $modelAlias sets an alias for the nested query
     * @param string|null $queryClass Allows to use a custom query class for the NOT IN query, like ExtendedBookQuery::class
     *
     * @return \TechWilk\Rota\SwapQuery The inner query object of the NOT IN statement
     */
    public function useNotInSwapRelatedByNewUserRoleIdQuery($modelAlias = null, $queryClass = null)
    {
        /** @var $q \TechWilk\Rota\SwapQuery */
        $q = $this->useInQuery('SwapRelatedByNewUserRoleId', $modelAlias, $queryClass, 'NOT IN');
        return $q;
    }
