...
abstract class Subscription implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TechWilk\\Rota\\Map\\SubscriptionTableMap';
    ...
    /**
     * The value for the topicid field.
     *
     * Note: this column has a database default value of: 0
     * @var        int
     */
    ...
    /**
     * Initializes internal state of TechWilk\Rota\Base\Subscription object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\TechWilk\Rota\Subscription The current object (for fluent API support)
     */
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[SubscriptionTableMap::COL_USERID] = true;
        }
    ...
    public function setCategoryid($v)
    {
        ...
        if ($this->categoryid !== $v) {
            $this->categoryid = $v;
            $this->modifiedColumns[SubscriptionTableMap::COL_CATEGORYID] = true;
        }
    ...
    /**
     * Set the value of [topicid] column.
     *
     * @param int $v new value
     * @return $this|\TechWilk\Rota\Subscription The current object (for fluent API support)
     */
    public function setTopicid($v)
    {
        ...
        if ($this->topicid !== $v) {
            $this->topicid = $v;
            $this->modifiedColumns[SubscriptionTableMap::COL_TOPICID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SubscriptionTableMap::translateFieldName('Userid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SubscriptionTableMap::translateFieldName('Categoryid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->categoryid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SubscriptionTableMap::translateFieldName('Topicid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->topicid = (null !== $col) ? (int) $col : null;
            $this->resetModified();
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\TechWilk\\Rota\\Subscription'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SubscriptionTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userid';
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_CATEGORYID)) {
            $modifiedColumns[':p' . $index++]  = 'categoryid';
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_TOPICID)) {
            $modifiedColumns[':p' . $index++]  = 'topicid';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'categoryid':
                        ...
                        break;
                    case 'topicid':
                        $stmt->bindValue($identifier, $this->topicid, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TechWilk\Rota\Subscription
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TechWilk\Rota\Subscription The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SubscriptionTableMap::COL_USERID)) {
            $criteria->add(SubscriptionTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_CATEGORYID)) {
            $criteria->add(SubscriptionTableMap::COL_CATEGORYID, $this->categoryid);
        }
        if ($this->isColumnModified(SubscriptionTableMap::COL_TOPICID)) {
            $criteria->add(SubscriptionTableMap::COL_TOPICID, $this->topicid);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TechWilk\Rota\Subscription (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TechWilk\Rota\Subscription Clone of current object.
     * @throws PropelException
     */
