...
abstract class LoginFailure implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TechWilk\\Rota\\Map\\LoginFailureTableMap';
    ...
    /**
     * Initializes internal state of TechWilk\Rota\Base\LoginFailure object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\TechWilk\Rota\LoginFailure The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\TechWilk\\Rota\\LoginFailure'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TechWilk\Rota\LoginFailure
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TechWilk\Rota\LoginFailure The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TechWilk\Rota\LoginFailure (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TechWilk\Rota\LoginFailure Clone of current object.
     * @throws PropelException
     */
