...
abstract class Permission implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\TechWilk\\Rota\\Map\\PermissionTableMap';
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildPermissionGroupPermission> Collection to store aggregation of ChildPermissionGroupPermission objects.
     */
     ...
     * @phpstan-var ObjectCollection&\Traversable<ChildPermissionGroupPermission>
     */
    protected $permissionGroupPermissionsScheduledForDeletion = null;

    /**
     * Initializes internal state of TechWilk\Rota\Base\Permission object.
     */
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : PermissionTableMap::translateFieldName('Slug', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\TechWilk\\Rota\\Permission'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of \TechWilk\Rota\Permission (or compatible) type.
     ...
     *
     * @param bool $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TechWilk\Rota\Permission Clone of current object.
     * @throws \Propel\Runtime\Exception\PropelException
     */
     ...
     * @return void
     */
    public function resetPartialPermissionGroupPermissions($v = true): void
    {
     ...
     * @return void
     */
    public function initPermissionGroupPermissions(bool $overrideExisting = true): void
    {
     ...
     * @phpstan-return ObjectCollection&\Traversable<ChildPermissionGroupPermission> List of ChildPermissionGroupPermission objects
     * @throws \Propel\Runtime\Exception\PropelException
     */
        ...
        if (null === $this->collPermissionGroupPermissions || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collPermissionGroupPermissions) {
                    ...
                    $collPermissionGroupPermissions = new $collectionClassName;
                    $collPermissionGroupPermissions->setModel('\TechWilk\Rota\PermissionGroupPermission');
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     */
    public function countPermissionGroupPermissions(?Criteria $criteria = null, bool $distinct = false, ?ConnectionInterface $con = null): int
    {
        $partial = $this->collPermissionGroupPermissionsPartial && !$this->isNew();
        if (null === $this->collPermissionGroupPermissions || null !== $criteria || $partial) {
     ...
     */
    protected function doAddPermissionGroupPermission(ChildPermissionGroupPermission $permissionGroupPermission): void
    {
