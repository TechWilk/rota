 ...
 */
abstract class CalendarToken implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    ...
    /**
     * Initializes internal state of TechWilk\Rota\Base\CalendarToken object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CalendarToken</code> instance.  If
     * <code>obj</code> is an instance of <code>CalendarToken</code>, delegates to
     * <code>equals(CalendarToken)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    public function setToken($v)
    {
        ...
        if ($this->token !== $v) {
            $this->token = $v;
            $this->modifiedColumns[CalendarTokenTableMap::COL_TOKEN] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[CalendarTokenTableMap::COL_USERID] = true;
        }
    ...
    public function setFormat($v)
    {
        ...
        if ($this->format !== $v) {
            $this->format = $v;
            $this->modifiedColumns[CalendarTokenTableMap::COL_FORMAT] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[CalendarTokenTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setRevoked($v)
    {
        ...
        if ($this->revoked !== $v) {
            $this->revoked = $v;
            $this->modifiedColumns[CalendarTokenTableMap::COL_REVOKED] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CalendarTokenTableMap::COL_CREATED] = true;
            }
        } // if either are not null
    ...
    public function setUpdated($v)
    {
        ...
        if ($this->updated !== null || $dt !== null) {
            if ($this->updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[CalendarTokenTableMap::COL_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CalendarTokenTableMap::translateFieldName('RevokedDate', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->revokeddate = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CalendarTokenTableMap::translateFieldName('LastFetched', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->lastfetched = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CalendarTokenTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CalendarTokenTableMap::translateFieldName('Updated', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 9; // 9 = CalendarTokenTableMap::NUM_HYDRATE_COLUMNS.
        } catch (Exception $e) {
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCalendarTokenQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCalendarTokenQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(CalendarTokenTableMap::COL_UPDATED)) {
                    $this->setUpdated(\Propel\Runtime\Util\PropelDateTime::createHighPrecision());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                CalendarTokenTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CalendarTokenTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userId';
        }
        if ($this->isColumnModified(CalendarTokenTableMap::COL_FORMAT)) {
            $modifiedColumns[':p' . $index++]  = 'format';
        }
        if ($this->isColumnModified(CalendarTokenTableMap::COL_DESCRIPTION)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[5] => $this->getRevokedDate(),
            $keys[6] => $this->getLastFetched(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setRevokedDate($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setLastFetched($arr[$keys[6]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CalendarTokenTableMap::COL_USERID)) {
            $criteria->add(CalendarTokenTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(CalendarTokenTableMap::COL_FORMAT)) {
            $criteria->add(CalendarTokenTableMap::COL_FORMAT, $this->format);
        }
        if ($this->isColumnModified(CalendarTokenTableMap::COL_DESCRIPTION)) {
            $criteria->add(CalendarTokenTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(CalendarTokenTableMap::COL_REVOKED)) {
        ...
        if ($this->isColumnModified(CalendarTokenTableMap::COL_UPDATED)) {
            $criteria->add(CalendarTokenTableMap::COL_UPDATED, $this->updated);
        }
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->userid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addCalendarTokens($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CalendarTokenTableMap::DEFAULT_STRING_FORMAT);
    }
