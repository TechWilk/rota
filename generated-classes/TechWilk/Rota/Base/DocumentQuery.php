 ...
 * @method     ChildDocumentQuery orderByDescription($order = Criteria::ASC) Order by the description column
 * @method     ChildDocumentQuery orderByUrl($order = Criteria::ASC) Order by the url column
 * @method     ChildDocumentQuery orderByLink($order = Criteria::ASC) Order by the link column
 *
 * @method     ChildDocumentQuery groupById() Group by the id column
 * @method     ChildDocumentQuery groupByTitle() Group by the title column
 * @method     ChildDocumentQuery groupByDescription() Group by the description column
 * @method     ChildDocumentQuery groupByUrl() Group by the url column
 * @method     ChildDocumentQuery groupByLink() Group by the link column
 *
 ...
 * @method     ChildDocument requireOneByDescription(string $description) Return the first ChildDocument filtered by the description column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
