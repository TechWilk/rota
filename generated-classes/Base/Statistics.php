...
abstract class Statistics implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\StatisticsTableMap';
    ...
    /**
     * Initializes internal state of Base\Statistics object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Statistics The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[StatisticsTableMap::COL_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[StatisticsTableMap::COL_USERID] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if (($dt != $this->date) // normalized values don't match
                ...
                $this->modifiedColumns[StatisticsTableMap::COL_DATE] = true;
            }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[StatisticsTableMap::COL_TYPE] = true;
        }
    ...
    public function setDetail1($v)
    {
        ...
        if ($this->detail1 !== $v) {
            $this->detail1 = $v;
            $this->modifiedColumns[StatisticsTableMap::COL_DETAIL1] = true;
        }
    ...
    public function setDetail2($v)
    {
        ...
        if ($this->detail2 !== $v) {
            $this->detail2 = $v;
            $this->modifiedColumns[StatisticsTableMap::COL_DETAIL2] = true;
        }
    ...
    public function setDetail3($v)
    {
        ...
        if ($this->detail3 !== $v) {
            $this->detail3 = $v;
            $this->modifiedColumns[StatisticsTableMap::COL_DETAIL3] = true;
        }
    ...
    public function setScript($v)
    {
        ...
        if ($this->script !== $v) {
            $this->script = $v;
            $this->modifiedColumns[StatisticsTableMap::COL_SCRIPT] = true;
        }
    ...
    {
        try {
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : StatisticsTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : StatisticsTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : StatisticsTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : StatisticsTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : StatisticsTableMap::translateFieldName('Detail1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->detail1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : StatisticsTableMap::translateFieldName('Detail2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->detail2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : StatisticsTableMap::translateFieldName('Detail3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->detail3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : StatisticsTableMap::translateFieldName('Script', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 8; // 8 = StatisticsTableMap::NUM_HYDRATE_COLUMNS.
        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Statistics'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStatisticsQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Statistics::setDeleted()
     * @see Statistics::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildStatisticsQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StatisticsTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(StatisticsTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userid';
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_DETAIL1)) {
            $modifiedColumns[':p' . $index++]  = 'detail1';
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_DETAIL2)) {
            $modifiedColumns[':p' . $index++]  = 'detail2';
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_DETAIL3)) {
            $modifiedColumns[':p' . $index++]  = 'detail3';
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_SCRIPT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StatisticsTableMap::COL_ID)) {
            $criteria->add(StatisticsTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_USERID)) {
            $criteria->add(StatisticsTableMap::COL_USERID, $this->userid);
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_DATE)) {
            $criteria->add(StatisticsTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_TYPE)) {
            $criteria->add(StatisticsTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_DETAIL1)) {
            $criteria->add(StatisticsTableMap::COL_DETAIL1, $this->detail1);
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_DETAIL2)) {
            $criteria->add(StatisticsTableMap::COL_DETAIL2, $this->detail2);
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_DETAIL3)) {
            $criteria->add(StatisticsTableMap::COL_DETAIL3, $this->detail3);
        }
        if ($this->isColumnModified(StatisticsTableMap::COL_SCRIPT)) {
            $criteria->add(StatisticsTableMap::COL_SCRIPT, $this->script);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Statistics (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Statistics Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->userid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addStatisticss($this);
             */
        }
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeStatistics($this);
        }
        $this->id = null;
        $this->userid = null;
        $this->date = null;
