 ...
 *
 * @method     \UserPermissionQuery|\PermissionGroupPermissionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildPermission findOneBySlug(string $slug) Return the first ChildPermission filtered by the slug column *
...
abstract class PermissionQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \PermissionGroupPermission object
     *
     * @param \PermissionGroupPermission|ObjectCollection $permissionGroupPermission the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildPermissionQuery The current query, for fluid interface
     */
    ...
    {
        if ($permissionGroupPermission instanceof \PermissionGroupPermission) {
            return $this
            ...
            throw new PropelException('filterByPermissionGroupPermission() only accepts arguments of type \PermissionGroupPermission or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \PermissionGroupPermissionQuery A secondary query class using the current class as primary query
     */
    public function usePermissionGroupPermissionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PermissionGroupPermission', '\PermissionGroupPermissionQuery');
    }
