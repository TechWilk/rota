...
abstract class PermissionGroupPermission implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PermissionGroupPermissionTableMap';
    ...
    /**
     * Initializes internal state of Base\PermissionGroupPermission object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PermissionGroupPermission The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PermissionGroupPermission'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PermissionGroupPermission
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PermissionGroupPermission (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PermissionGroupPermission Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if ($this->aPermissionGroup === null && ($this->permissiongroupid !== null)) {
