 ...
 *
 * @method     \UserQuery|\RoleQuery|\EventPersonQuery|\SwapQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserRoleQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\UserRoleQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\UserRole', $modelAlias = null)
    {
    ...
    public function filterBySwapRelatedByOldUserRoleId($swap, $comparison = null)
    {
        if ($swap instanceof \Swap) {
            ...
            throw new PropelException('filterBySwapRelatedByOldUserRoleId() only accepts arguments of type \Swap or Collection');
        }
    }
    ...
    public function useSwapRelatedByOldUserRoleIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SwapRelatedByOldUserRoleId', '\SwapQuery');
    }
    ...
    public function filterBySwapRelatedByNewUserRoleId($swap, $comparison = null)
    {
        if ($swap instanceof \Swap) {
            ...
            throw new PropelException('filterBySwapRelatedByNewUserRoleId() only accepts arguments of type \Swap or Collection');
        }
    }
    ...
    public function useSwapRelatedByNewUserRoleIdQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'SwapRelatedByNewUserRoleId', '\SwapQuery');
    }
