...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of Base\UserRole object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\UserRole The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\UserRole'), 0, $e);
        }
    }
    ...
    public function initEventpeople($overrideExisting = true)
    {
        ...
        $this->collEventpeople->setModel('\EventPerson');
    }
    ...
    public function initSwapsRelatedByOldUserRoleId($overrideExisting = true)
    {
        ...
        $this->collSwapsRelatedByOldUserRoleId->setModel('\Swap');
    }
    ...
    public function initSwapsRelatedByNewUserRoleId($overrideExisting = true)
    {
        ...
        $this->collSwapsRelatedByNewUserRoleId->setModel('\Swap');
    }
