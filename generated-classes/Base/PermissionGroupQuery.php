...
use \PermissionGroup as ChildPermissionGroup;
use \PermissionGroupQuery as ChildPermissionGroupQuery;
use \Exception;
use \PDO;
use Map\PermissionGroupTableMap;
 ...
 *
 * @method     \PermissionGroupPermissionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PermissionGroupQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\PermissionGroupQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PermissionGroup', $modelAlias = null)
    {
