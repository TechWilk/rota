...
use \PermissionGroupPermission as ChildPermissionGroupPermission;
use \PermissionGroupPermissionQuery as ChildPermissionGroupPermissionQuery;
use \Exception;
use \PDO;
use Map\PermissionGroupPermissionTableMap;
 ...
 *
 * @method     \PermissionQuery|\PermissionGroupQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class PermissionGroupPermissionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\PermissionGroupPermissionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PermissionGroupPermission', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \PermissionGroup object
     *
     * @param \PermissionGroup|ObjectCollection $permissionGroup The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByPermissionGroup($permissionGroup, $comparison = null)
    {
        if ($permissionGroup instanceof \PermissionGroup) {
            ...
            throw new PropelException('filterByPermissionGroup() only accepts arguments of type \PermissionGroup or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \PermissionGroupQuery A secondary query class using the current class as primary query
     */
    public function usePermissionGroupQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'PermissionGroup', '\PermissionGroupQuery');
    }
