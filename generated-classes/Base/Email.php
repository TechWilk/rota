...
abstract class Email implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EmailTableMap';
    ...
    /**
     * The value for the emailbcc field.
     *
     * Note: this column has a database default value of: ''
     * @var        string
     */
    ...
    /**
     * The value for the emailfrom field.
     *
     * @var        string
     */
    protected $emailfrom;
    ...
    /**
     * Initializes internal state of Base\Email object.
     * @see applyDefaults()
     */
    ...
    /**
     * Get the [emailfrom] column value.
     *
     * @return string
     */
    ...
    public function setEmailTo($v)
    {
        ...
        if ($this->emailto !== $v) {
            $this->emailto = $v;
            $this->modifiedColumns[EmailTableMap::COL_EMAILTO] = true;
        }
    ...
    public function setEmailBcc($v)
    {
        ...
        if ($this->emailbcc !== $v) {
            $this->emailbcc = $v;
            $this->modifiedColumns[EmailTableMap::COL_EMAILBCC] = true;
        }
    ...
    public function setEmailFrom($v)
    {
        ...
        if ($this->emailfrom !== $v) {
            $this->emailfrom = $v;
            $this->modifiedColumns[EmailTableMap::COL_EMAILFROM] = true;
        }
    ...
    public function setSubject($v)
    {
        ...
        if ($this->subject !== $v) {
            $this->subject = $v;
            $this->modifiedColumns[EmailTableMap::COL_SUBJECT] = true;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[EmailTableMap::COL_MESSAGE] = true;
        }
    ...
    public function setError($v)
    {
        ...
        if ($this->error !== $v) {
            $this->error = $v;
            $this->modifiedColumns[EmailTableMap::COL_ERROR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EmailTableMap::translateFieldName('EmailTo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->emailto = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : EmailTableMap::translateFieldName('EmailBcc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->emailbcc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : EmailTableMap::translateFieldName('EmailFrom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->emailfrom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : EmailTableMap::translateFieldName('Subject', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subject = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : EmailTableMap::translateFieldName('Message', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Email'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EmailTableMap::COL_EMAILTO)) {
            $modifiedColumns[':p' . $index++]  = 'emailTo';
        }
        if ($this->isColumnModified(EmailTableMap::COL_EMAILBCC)) {
            $modifiedColumns[':p' . $index++]  = 'emailBcc';
        }
        if ($this->isColumnModified(EmailTableMap::COL_EMAILFROM)) {
            $modifiedColumns[':p' . $index++]  = 'emailFrom';
        }
        if ($this->isColumnModified(EmailTableMap::COL_SUBJECT)) {
            $modifiedColumns[':p' . $index++]  = 'subject';
        }
        if ($this->isColumnModified(EmailTableMap::COL_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'message';
        }
        if ($this->isColumnModified(EmailTableMap::COL_ERROR)) {
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setEmailTo($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setEmailBcc($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setEmailFrom($arr[$keys[3]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EmailTableMap::COL_EMAILTO)) {
            $criteria->add(EmailTableMap::COL_EMAILTO, $this->emailto);
        }
        if ($this->isColumnModified(EmailTableMap::COL_EMAILBCC)) {
            $criteria->add(EmailTableMap::COL_EMAILBCC, $this->emailbcc);
        }
        if ($this->isColumnModified(EmailTableMap::COL_EMAILFROM)) {
            $criteria->add(EmailTableMap::COL_EMAILFROM, $this->emailfrom);
        }
        if ($this->isColumnModified(EmailTableMap::COL_SUBJECT)) {
            $criteria->add(EmailTableMap::COL_SUBJECT, $this->subject);
        }
        if ($this->isColumnModified(EmailTableMap::COL_MESSAGE)) {
            $criteria->add(EmailTableMap::COL_MESSAGE, $this->message);
        }
        if ($this->isColumnModified(EmailTableMap::COL_ERROR)) {
            $criteria->add(EmailTableMap::COL_ERROR, $this->error);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setEmailFrom($this->getEmailFrom());
