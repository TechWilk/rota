...
use \EventSubType as ChildEventSubType;
use \EventSubTypeQuery as ChildEventSubTypeQuery;
use \Exception;
use \PDO;
use Map\EventSubTypeTableMap;
 ...
 */
abstract class EventSubType implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EventSubTypeTableMap';
    ...
    /**
     * Initializes internal state of Base\EventSubType object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>EventSubType</code> instance.  If
     * <code>obj</code> is an instance of <code>EventSubType</code>, delegates to
     * <code>equals(EventSubType)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     * @return $this|\EventSubType The current object (for fluent API support)
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[EventSubTypeTableMap::COL_NAME] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[EventSubTypeTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : EventSubTypeTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EventSubType'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildEventSubTypeQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildEventSubTypeQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventSubTypeTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(EventSubTypeTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(EventSubTypeTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(EventSubTypeTableMap::COL_DESCRIPTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventSubTypeTableMap::COL_NAME)) {
            $criteria->add(EventSubTypeTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(EventSubTypeTableMap::COL_DESCRIPTION)) {
            $criteria->add(EventSubTypeTableMap::COL_DESCRIPTION, $this->description);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EventSubType (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EventSubType Clone of current object.
     * @throws PropelException
     */
    ...
    public function setEvents(Collection $events, ConnectionInterface $con = null)
    {
        ...
        foreach ($eventsToDelete as $eventRemoved) {
            $eventRemoved->setEventSubType(null);
        }
     ...
     * Otherwise if this EventSubType is new, it will return
     * an empty collection; or if this EventSubType has previously
    ...
    {
        return (string) $this->exportTo(EventSubTypeTableMap::DEFAULT_STRING_FORMAT);
    }
