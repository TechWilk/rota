...
use \DiscussionCategories as ChildDiscussionCategories;
...
abstract class DiscussionCategoriesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\DiscussionCategoriesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\DiscussionCategories', $modelAlias = null)
    {
