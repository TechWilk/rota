 ...
 *
 * @method     \EventPersonQuery|\UserRoleQuery|\UserQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SwapQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\SwapQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Swap', $modelAlias = null)
    {
     ...
     *
     * @param \EventPerson|ObjectCollection $eventPerson The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
     ...
     *
     * @param \UserRole|ObjectCollection $userRole The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByOldUserRole($userRole, $comparison = null)
    {
        if ($userRole instanceof \UserRole) {
            ...
            throw new PropelException('filterByOldUserRole() only accepts arguments of type \UserRole or Collection');
        }
    }
    ...
    public function useOldUserRoleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'OldUserRole', '\UserRoleQuery');
    }
    ...
    public function filterByNewUserRole($userRole, $comparison = null)
    {
        if ($userRole instanceof \UserRole) {
            ...
            throw new PropelException('filterByNewUserRole() only accepts arguments of type \UserRole or Collection');
        }
    }
    ...
    public function useNewUserRoleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'NewUserRole', '\UserRoleQuery');
    }
