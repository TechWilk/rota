 ...
 *
 * @method     \EventQuery|\UserRoleQuery|\SwapQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventPersonQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\EventPersonQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\EventPerson', $modelAlias = null)
    {
