 ...
 *
 * @method     \UserQuery|\EventTypeQuery|\EventSubTypeQuery|\LocationQuery|\EventGroupQuery|\EventPersonQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class EventQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \EventSubType object
     *
     * @param \EventSubType|ObjectCollection $eventSubType The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($eventSubType instanceof \EventSubType) {
            return $this
            ...
            throw new PropelException('filterByEventSubType() only accepts arguments of type \EventSubType or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EventSubTypeQuery A secondary query class using the current class as primary query
     */
    public function useEventSubTypeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'EventSubType', '\EventSubTypeQuery');
    }
    ...
    /**
     * Filter the query by a related \EventGroup object
     *
     * @param \EventGroup|ObjectCollection $eventGroup The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    public function filterByEventGroup($eventGroup, $comparison = null)
    {
        if ($eventGroup instanceof \EventGroup) {
            ...
            throw new PropelException('filterByEventGroup() only accepts arguments of type \EventGroup or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EventGroupQuery A secondary query class using the current class as primary query
     */
    public function useEventGroupQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinEventGroup($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'EventGroup', '\EventGroupQuery');
    }

    /**
     * Filter the query by a related \EventPerson object
     *
     * @param \EventPerson|ObjectCollection $eventPerson the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildEventQuery The current query, for fluid interface
     */
    ...
    {
        if ($eventPerson instanceof \EventPerson) {
            return $this
            ...
            throw new PropelException('filterByEventPerson() only accepts arguments of type \EventPerson or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \EventPersonQuery A secondary query class using the current class as primary query
     */
    public function useEventPersonQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'EventPerson', '\EventPersonQuery');
    }
