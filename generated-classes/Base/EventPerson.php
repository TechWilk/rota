...
abstract class EventPerson implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\EventPersonTableMap';
    ...
    /**
     * Initializes internal state of Base\EventPerson object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\EventPerson The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\EventPerson'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \EventPerson (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \EventPerson Clone of current object.
     * @throws PropelException
     */
