...
use \CalendarToken as ChildCalendarToken;
use \CalendarTokenQuery as ChildCalendarTokenQuery;
use \User as ChildUser;
use \UserQuery as ChildUserQuery;
use \DateTime;
use \Exception;
use \PDO;
use Map\CalendarTokenTableMap;
...
abstract class CalendarToken implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CalendarTokenTableMap';
    ...
    /**
     * Initializes internal state of Base\CalendarToken object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\CalendarToken The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\CalendarToken'), 0, $e);
        }
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CalendarToken (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CalendarToken Clone of current object.
     * @throws PropelException
     */
