...
use \SocialAuthQuery as ChildSocialAuthQuery;
use \User as ChildUser;
use \UserQuery as ChildUserQuery;
use \Exception;
use \PDO;
use Map\SocialAuthTableMap;
 ...
 */
abstract class SocialAuth implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SocialAuthTableMap';
    ...
    /**
     * Initializes internal state of Base\SocialAuth object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>SocialAuth</code> instance.  If
     * <code>obj</code> is an instance of <code>SocialAuth</code>, delegates to
     * <code>equals(SocialAuth)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SocialAuth The current object, for fluid interface
     */
     ...
     * @return $this|\SocialAuth The current object (for fluent API support)
     */
    public function setUserId($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[SocialAuthTableMap::COL_USERID] = true;
        }
    ...
    public function setPlatform($v)
    {
        ...
        if ($this->platform !== $v) {
            $this->platform = $v;
            $this->modifiedColumns[SocialAuthTableMap::COL_PLATFORM] = true;
        }
    ...
    public function setSocialId($v)
    {
        ...
        if ($this->socialid !== $v) {
            $this->socialid = $v;
            $this->modifiedColumns[SocialAuthTableMap::COL_SOCIALID] = true;
        }
    ...
    public function setRevoked($v)
    {
        ...
        if ($this->revoked !== $v) {
            $this->revoked = $v;
            $this->modifiedColumns[SocialAuthTableMap::COL_REVOKED] = true;
        }
    ...
    {
        try {
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SocialAuthTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SocialAuthTableMap::translateFieldName('Platform', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\SocialAuth'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSocialAuthQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SocialAuth::setDeleted()
     * @see SocialAuth::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSocialAuthQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SocialAuthTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SocialAuthTableMap::COL_USERID)) {
            $modifiedColumns[':p' . $index++]  = 'userId';
        }
        if ($this->isColumnModified(SocialAuthTableMap::COL_PLATFORM)) {
    ...
    {
        $pos = SocialAuthTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['SocialAuth'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SocialAuth'][$this->hashCode()] = true;
        $keys = SocialAuthTableMap::getFieldNames($keyType);
        $result = array(
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SocialAuth (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SocialAuth Clone of current object.
     * @throws PropelException
     */
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeSocialAuth($this);
        }
        $this->userid = null;
        $this->platform = null;
        $this->socialid = null;
    ...
    {
        return (string) $this->exportTo(SocialAuthTableMap::DEFAULT_STRING_FORMAT);
    }
