...
abstract class PermissionGroup implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PermissionGroupTableMap';
    ...
    /**
     * Initializes internal state of Base\PermissionGroup object.
     */
     ...
     * @return $this|\PermissionGroup The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PermissionGroup'), 0, $e);
        }
    }
