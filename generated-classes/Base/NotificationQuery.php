 ...
 *
 * @method     \UserQuery|\NotificationClickQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class NotificationQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\NotificationQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Notification', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \NotificationClick object
     *
     * @param \NotificationClick|ObjectCollection $notificationClick the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildNotificationQuery The current query, for fluid interface
     */
    ...
    {
        if ($notificationClick instanceof \NotificationClick) {
            return $this
            ...
            throw new PropelException('filterByNotificationClick() only accepts arguments of type \NotificationClick or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \NotificationClickQuery A secondary query class using the current class as primary query
     */
    public function useNotificationClickQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'NotificationClick', '\NotificationClickQuery');
    }
