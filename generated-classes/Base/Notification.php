...
abstract class Notification implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\NotificationTableMap';
    ...
    /**
     * Initializes internal state of Base\Notification object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Notification The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Notification'), 0, $e);
        }
    }
    ...
    public function initNotificationClicks($overrideExisting = true)
    {
        ...
        $this->collNotificationClicks->setModel('\NotificationClick');
    }
