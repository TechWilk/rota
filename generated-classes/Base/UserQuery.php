 ...
 *
 * @method     \CalendarTokenQuery|\EventQuery|\NotificationQuery|\SocialAuthQuery|\StatisticQuery|\SwapQuery|\UserRoleQuery|\UserPermissionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UserQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \CalendarToken object
     *
     * @param \CalendarToken|ObjectCollection $calendarToken the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    {
        if ($calendarToken instanceof \CalendarToken) {
            return $this
            ...
            throw new PropelException('filterByCalendarToken() only accepts arguments of type \CalendarToken or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \CalendarTokenQuery A secondary query class using the current class as primary query
     */
    public function useCalendarTokenQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CalendarToken', '\CalendarTokenQuery');
    }
     ...
     *
     * @param \Notification|ObjectCollection $notification the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByNotification($notification, $comparison = null)
    {
        if ($notification instanceof \Notification) {
            ...
            throw new PropelException('filterByNotification() only accepts arguments of type \Notification or Collection');
        }
    }
    ...
    /**
     * Filter the query by a related \SocialAuth object
     *
     * @param \SocialAuth|ObjectCollection $socialAuth the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterBySocialAuth($socialAuth, $comparison = null)
    {
        if ($socialAuth instanceof \SocialAuth) {
            ...
            throw new PropelException('filterBySocialAuth() only accepts arguments of type \SocialAuth or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SocialAuthQuery A secondary query class using the current class as primary query
     */
    public function useSocialAuthQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSocialAuth($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'SocialAuth', '\SocialAuthQuery');
    }
    ...
    /**
     * Filter the query by a related \Swap object
     *
     * @param \Swap|ObjectCollection $swap the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterBySwap($swap, $comparison = null)
    {
        if ($swap instanceof \Swap) {
            ...
            throw new PropelException('filterBySwap() only accepts arguments of type \Swap or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \SwapQuery A secondary query class using the current class as primary query
     */
    public function useSwapQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSwap($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Swap', '\SwapQuery');
    }
    ...
    /**
     * Filter the query by a related \UserPermission object
     *
     * @param \UserPermission|ObjectCollection $userPermission the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByUserPermission($userPermission, $comparison = null)
    {
        if ($userPermission instanceof \UserPermission) {
            ...
            throw new PropelException('filterByUserPermission() only accepts arguments of type \UserPermission or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \UserPermissionQuery A secondary query class using the current class as primary query
     */
    public function useUserPermissionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'UserPermission', '\UserPermissionQuery');
    }
